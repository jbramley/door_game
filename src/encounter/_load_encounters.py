...
def load_encounters() -> dict[EncounterName, Encounter]:
    encounters = [
        ...
        Encounter(
            name="in_the_woods",
            description="You are standing among very tall and very old oak trees. There is little vegetation under your feet, but a lot of crunchy leaves.",
            actions=[
                EncounterAction("l", "[L]ook for dropbears", LookForEnemyAction("dropbear", 0.25, EncounterName("combat_Dropbear"))),
